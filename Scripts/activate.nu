...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\santej\Desktop\updsite\store-server\djangoProject'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\santej\Desktop\updsite\store-server\djangoProject\Scripts\deactivate.nu'
